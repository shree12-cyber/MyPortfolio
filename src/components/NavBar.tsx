...
export default function NavBar({
  ...
  return (
    <nav
      ...
      className="rounded-[10px] border border-white/20 bg-black/25 backdrop-blur-[9.5px]"
    >
      <ul className="flex flex-col justify-between px-4 md:m-4 md:flex-row md:items-center">
